...
export const REQUIRED_MICROCOSM_EXPORTS = Object.freeze([
    ...
    "microcosm_inspect_cell_detail",
    "microcosm_inspect_cell_elements",
    "microcosm_inspect_cell_fluxes",
    ...
    "microcosm_tile_mass_density_ptr",
    "microcosm_tile_total_elements_ptr",
    "microcosm_tile_element_concentrations_ptr",
    "microcosm_tile_element_concentrations_len",
    "microcosm_lattice_rgba_ptr",
    "microcosm_lattice_rgba_len",
...
export const assertMicrocosmExports = (exportsObject, requiredExports = REQUIRED_MICROCOSM_EXPORTS) => {
    ...
    if (missing.length > 0) throw new Error(`Microcosm WebAssembly is missing required export(s): ${missing.join(", ")}. The checked-in ./rust/microcosm.wasm is likely stale; rebuild it from ./rust/ after applying the current Rust sources.`);
};
